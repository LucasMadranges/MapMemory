      ...
      className={`relative transition
          ...
          flex flex-col items-center justify-center gap-2
            ...
            ${
              ...
              'sm:hover:after:top-14 sm:hover:after:left-1/2 sm:hover:after:-translate-x-1/2'
            }
            ${
              textDirection === 'top' &&
              'sm:hover:after:bottom-14 sm:hover:after:left-1/2 sm:hover:after:-translate-x-1/2'
            }
            ${
              textDirection === 'left' &&
              'sm:hover:after:top-1/2 sm:hover:after:right-14 sm:hover:after:-translate-y-1/2'
            }
            ${
              textDirection === 'right' &&
