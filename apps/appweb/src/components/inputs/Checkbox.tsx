...
export default function Checkbox({
  ...
  return (
    <div
      className={`flex items-center justify-start gap-2 ${containerClassName}`}
    >
      <div className={'relative flex items-center justify-center'}>
        ...
        {check && (
          <Check
            onClick={handleClick}
            className={
              'cursor-pointer w-3 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 text-white'
            }
          />
        )}
      </div>
