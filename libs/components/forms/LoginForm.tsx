  ...
  return (
    <form className="bg-white rounded-2xl shadow p-8 md:p-12">
      ...
      <Input
        ...
        enabledPasswordIcon={<Eye width={24} height={24} />}
        disabledPasswordIcon={<DisabledEye width={24} height={24} />}
      />
      <Checkbox name={'remember'} label={'Se souvenir de moi'} />
      <HorizontalBar />
      <Button type={'primary'} className={'py-2'} isLoading={isLoading} onClick={handleSubmit}>
        Se connecter
      </Button>
    </form>
  );
